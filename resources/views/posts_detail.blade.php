...
@section('content')
    @include('layouts_main.sub_hero_h2', ['bradcam_title' => '醫生專欄 / Blogs'])
                    ...
                    <div class="single-post">
                        ...
                        <div class="blog_details table-responsive">
                            ...
                            <ul class="blog-info-link mt-3 mb-4 ml-auto">
                                <li><a href="{{ route('blog', DB::table('post_type_infos')->where('id', $postInfo->post_type)->value('type_slug'))  }}"><i class="fas fa-flag"></i> {{ DB::table('post_type_infos')->where('id', $postInfo->post_type)->value('type_name') }}</a></li>
