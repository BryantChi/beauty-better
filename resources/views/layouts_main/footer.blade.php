...
<footer class="footer footer_bg">
    ...
    <div class="footer_copy_right">
        <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            ...
            </script> All rights reserved | 美美上美 <i class="fas fa-heart"
                aria-hidden="true"></i> design by <a href="mailto:bryantchi.work@gmail.com" target="_blank">MWStudio - Bryant</a>
