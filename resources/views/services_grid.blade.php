                            ...
                            <article class="blog_item">
                                ...
                                <div class="blog_details">
                                    ...
                                    <ul class="blog-info-link mt-3 mb-4 ml-auto">
                                        <li><a href="{{ route('services.items', DB::table('post_type_infos')->where('id', $post->post_type)->value('type_slug'))  }}"><i class="fas fa-flag"></i>
                                    ...
                                    <div class="w-100 text-right">
                                        ...
                                        href="{{ route('services.items.show', ['type' => DB::table('post_type_infos')->where('id', $post->post_type)->value('type_slug'), 'slug' => $post->post_slug]) }}">繼續閱讀 》</a>
                                    </div>
                                </div>
                            </article>
                        @endforeach
